...
TEST_CASE("httprequest_read - Request Line", "[weight=1][part=2][first]") {
...
TEST_CASE("httprequest_read - First Header", "[weight=1][part=2][second]") {
  HTTPRequest *req = _readpipe("GET / HTTP/1.1\r\nHost: localhost\r\n\r\n");
...
TEST_CASE("httprequest_read - Two Headers", "[weight=1][part=2][third]") {
  HTTPRequest *req = _readpipe("GET / HTTP/1.1\r\nHello: World\r\nHost: 127.0.0.1\r\n\r\n");
...
TEST_CASE("httprequest_read - Content-Length Header", "[weight=1][part=2][fourth]") {
  HTTPRequest *req = _readpipe("GET / HTTP/1.1\r\nHello: World\r\nHost: 127.0.0.1\r\nContent-Length: 10\r\n\r\n0123456789");
...
TEST_CASE("httprequest_read - No Content-Length results in a NULL payload", "[weight=2][part=2][fifth]") {
  HTTPRequest *req = _readpipe("GET / HTTP/1.1\r\nHello: World\r\nHost: 127.0.0.1\r\n\r\n");
...
TEST_CASE("httprequest_read - ASCII Payload Data", "[weight=2][part=2][sixth]") {
  HTTPRequest *req = _readpipe("GET / HTTP/1.1\r\nHello: World\r\nHost: 127.0.0.1\r\nContent-Length: 10\r\n\r\n0123456789");
...
TEST_CASE("httprequest_read - Payload Binary Payload", "[weight=2][part=2][seventh]") {
